...
function program4(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\" class=\"submitbtn btn btn-large btn-primary attributeTarget eventTarget\">Go To Forum</a>\n\n</div>";
  return buffer;
  });
