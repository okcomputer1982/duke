DukeApp.module("Entities", function(Entities, DukeApp, Backbone, Marionette, $, _){
	...
	var initializePanels = function() {
		panels = new Entities.PanelCollection([
			...
			{seriesId:0, panelId:4, display:false, question:{show:true, 	prompt:"What do you think Xin Xin, do you want to attend college in US?", choice_0:{text:"Yes I am totally sure.", nextSlide:5}, choice_1:{text:"Yes but I want to learn more.", nextSlide:6}, choice_2:{text:"I am having second thoughts but need more info", nextSlide:7}}},
			{seriesId:0, panelId:5, display:false, question:{show:false, 	nextSlide:8}},
			{seriesId:0, panelId:6, display:false, question:{show:false, 	nextSlide:8}},
			{seriesId:0, panelId:7, display:false, question:{show:false, 	nextSlide:8}},
			{seriesId:0, panelId:8, display:false, question:{show:true, 	prompt:"How would you like to complete your degree? In US, you can either choose to arrange your own schedule or follow a designated schedule by discussing with your academic advisor.", choice_0:{text:"Arrange my own schedule, choose courses to take for each semester on my own.", nextSlide:9}, choice_1:{text:"Follow the designated schedule and take four years to complete the degree.", nextSlide:9}, choice_2:{text:"I am having second thoughts but need more info", nextSlide:10}}},
			{seriesId:0, panelId:9, display:false, question:{show:false, 	nextSlide:11}},
			...
			{seriesId:0, panelId:14, display:false, question:{show:false, 	nextSlide:15}},
			...
			{seriesId:0, panelId:17, display:false, question:{show:false, 	nextSlide:18}},
			{seriesId:0, panelId:18, display:false, question:{show:false, 	close:true}},
